...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_loc_spatial_idx ON panic_emergency_location USING GIST (location);",
            reverse_sql="DROP INDEX IF EXISTS emergency_loc_spatial_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_loc_user_active_idx ON panic_emergency_location (user_id, is_active);",
            reverse_sql="DROP INDEX IF EXISTS emergency_loc_user_active_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_loc_type_active_idx ON panic_emergency_location (emergency_type, is_active);",
            reverse_sql="DROP INDEX IF EXISTS emergency_loc_type_active_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_loc_created_idx ON panic_emergency_location (created_at);",
            reverse_sql="DROP INDEX IF EXISTS emergency_loc_created_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_loc_user_type_idx ON panic_emergency_location (user_id, emergency_type, is_active);",
            reverse_sql="DROP INDEX IF EXISTS emergency_loc_user_type_idx;"
        ),
        
        # Add indexes for EmergencyZone
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_zone_spatial_idx ON panic_emergency_zone USING GIST (boundary);",
            reverse_sql="DROP INDEX IF EXISTS emergency_zone_spatial_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_zone_type_active_idx ON panic_emergency_zone (zone_type, is_active);",
            reverse_sql="DROP INDEX IF EXISTS emergency_zone_type_active_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_zone_priority_idx ON panic_emergency_zone (priority);",
            reverse_sql="DROP INDEX IF EXISTS emergency_zone_priority_idx;"
        ),
        
        # Add indexes for EmergencyMedical
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_med_user_consent_idx ON panic_emergency_medical (user_id, consent_level);",
            reverse_sql="DROP INDEX IF EXISTS emergency_med_user_consent_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_med_consent_exp_idx ON panic_emergency_medical (consent_expires_at);",
            reverse_sql="DROP INDEX IF EXISTS emergency_med_consent_exp_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_med_encryption_idx ON panic_emergency_medical (is_encrypted);",
            reverse_sql="DROP INDEX IF EXISTS emergency_med_encryption_idx;"
        ),
        
        # Add indexes for MedicalCondition
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY med_condition_name_idx ON panic_medical_condition (name);",
            reverse_sql="DROP INDEX IF EXISTS med_condition_name_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY med_condition_severity_idx ON panic_medical_condition (severity_level);",
            reverse_sql="DROP INDEX IF EXISTS med_condition_severity_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY med_condition_emergency_idx ON panic_medical_condition (requires_immediate_attention);",
            reverse_sql="DROP INDEX IF EXISTS med_condition_emergency_idx;"
        ),
        
        # Add indexes for Medication
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY medication_name_idx ON panic_medication (name);",
            reverse_sql="DROP INDEX IF EXISTS medication_name_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY medication_generic_name_idx ON panic_medication (generic_name);",
            reverse_sql="DROP INDEX IF EXISTS medication_generic_name_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY medication_type_idx ON panic_medication (medication_type);",
            reverse_sql="DROP INDEX IF EXISTS medication_type_idx;"
        ),
        
        # Add indexes for Allergy
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY allergy_name_idx ON panic_allergy (name);",
            reverse_sql="DROP INDEX IF EXISTS allergy_name_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY allergy_severity_idx ON panic_allergy (severity_level);",
            reverse_sql="DROP INDEX IF EXISTS allergy_severity_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY allergy_emergency_idx ON panic_allergy (requires_immediate_attention);",
            reverse_sql="DROP INDEX IF EXISTS allergy_emergency_idx;"
        ),
        
        # Add indexes for EmergencyAuditLog
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_audit_action_idx ON panic_emergency_audit_log (action_type, timestamp);",
            reverse_sql="DROP INDEX IF EXISTS emergency_audit_action_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_audit_user_idx ON panic_emergency_audit_log (user_id, timestamp);",
            reverse_sql="DROP INDEX IF EXISTS emergency_audit_user_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_audit_severity_idx ON panic_emergency_audit_log (severity, timestamp);",
            reverse_sql="DROP INDEX IF EXISTS emergency_audit_severity_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_audit_content_idx ON panic_emergency_audit_log (content_type_id, object_id);",
            reverse_sql="DROP INDEX IF EXISTS emergency_audit_content_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_audit_ip_idx ON panic_emergency_audit_log (ip_address, timestamp);",
            reverse_sql="DROP INDEX IF EXISTS emergency_audit_ip_idx;"
        ),
        migrations.RunSQL(
            "CREATE INDEX CONCURRENTLY emergency_audit_session_idx ON panic_emergency_audit_log (session_id, timestamp);",
